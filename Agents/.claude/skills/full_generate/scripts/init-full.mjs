...
if (import.meta.url === pathToFileURL(process.argv[1]).href) {
  try {
    ...
    process.stderr.write(`${JSON.stringify({ ok: false, stage: "full_generate", tool: "init", message: error.message, next_action: error.nextAction || "检查完整剧本、剧本大纲及首次生成所需的已确认试稿后重新初始化。" }, null, 2)}\n`);
    process.exitCode = 1;
  }
}
